...
const VoiceAgent: React.FC = () => {
  ...
  const startCall = async () => {
    ...
    try {
      const ai = new GoogleGenAI({ apiKey: API_KEY_DIRECT });
      ...
      const sessionPromise = ai.live.connect({
        ...
        config: {
          ...
          Cuando el usuario inicie la llamada o te salude, responde con mucha calidez paisa y pregunta: "¿En qué te puedo ayudar hoy?". 
          Eres experta en el proyecto educativo GLOCEROVA, el Pensamiento Computacional y la tecnología para niños. 
          Tu objetivo es guiar a los padres y mentores con amabilidad y claridad sobre cómo estamos transformando el futuro de los niños en Colombia.`,
        },
      });
  ...
  return (
    <div className="fixed bottom-6 right-24 z-50 flex flex-col items-end pointer-events-none">
      ...
      <button 
        ...
        className={`pointer-events-auto flex items-center gap-3 px-6 py-4 rounded-full font-bold shadow-xl transition-all duration-300 hover:scale-105 active:scale-95 ${
          isActive 
